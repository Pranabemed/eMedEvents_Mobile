                ...
                <View>
                    <View style={styles.container}>
                        <View style={styles.header}>
                            <Image source={Imagepath.CmeImg} style={styles.image} />
                            <Text style={styles.title}>{"CME Allowance Tracking"}</Text>
                        </View>
                        <Text style={styles.description}>
                            {"Efficiently store CME expenditures records and \n proofs of eligible spend categories."}
                        </Text>
                    </View>
                    <View style={styles.container}>
                        <View style={styles.header}>
                        <Image source={Imagepath.FileCME} style={styles.image} />
                            <Text style={styles.title}>{"Share for Reimbursement"}</Text>
                        </View>
                        <Text style={styles.description}>
                            {"Quickly share proof of your CME expenditures to \n ensure timely reimbursement."}
                        </Text>
                    </View>
                </View>
