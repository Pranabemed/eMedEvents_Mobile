/**
 * Login change mail screen module. Renders a React Native screen or a screen-scoped support component. Exported members: status, LoginChangeMail, handleChangeEmail, styles.
 */
...
/**
 * Login change mail default export.
 *
 * @returns {*}
 */
