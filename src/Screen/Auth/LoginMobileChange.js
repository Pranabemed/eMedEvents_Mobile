...
/**
 * Reusable LoginMobileChange component.
 * 
 * @component
 * @param {Object} props - The component props.
 * @returns {JSX.Element}
 */
const LoginMobileChange = (props) => {
 ...
 */
    ...
    console.log(props?.route?.params, "phonecode--------")
    ...
    const finalBack = () => {
        ...
        props.navigation.navigate("LoginMobile", { Newphone: { phoneCode: getPhCdSent, allNo: origPhone, "phone": origPhone, "Verifycell": AuthReducer?.changephoneResponse?.phone_otp } })
    }
        /**
            ...
            >
                <SafeAreaView style={{ flex: 1, backgroundColor: Colorpath.Pagebg }}>
                    ...
                    <View style={styles.headerContainer}>
                        <Text style={styles.headerText}>{"Change Cell Number"}</Text>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "center", marginTop: normalize(20) }}>
                        <TouchableOpacity onPress={finalBack}>
